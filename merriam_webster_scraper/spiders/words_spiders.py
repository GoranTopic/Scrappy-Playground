...
class WordSpider(scrapy.Spider):
    ...
    def parseWordEntry(self, response):
        ...
        #get synonyms
        word["synonyms"] = response.xpath('//div[@id="synonyms-anchor"]/p[@class="function-label"][text()="Synonyms "]/following::ul[1]/li/a/text()').getall()
        #get antonyms
        word["antonyms"] = response.xpath('//div[@id="synonyms-anchor"]/p[@class="function-label"][text()="Antonyms "]/following::ul[1]/li/a/text()').getall()
